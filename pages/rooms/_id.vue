<template>
  <div v-if="room" class="container my-5">
    <div class="hero-container mt-4 mb-8">
      <img :src="room.image" alt="">
      <div class="room-info">
        <h1>{{room.title}}</h1>
        <p class="snippet">{{room.snippet}}</p>
        <Calendar />
        <v-btn color="primary">Rent</v-btn>
      </div>
    </div>
    <hr />
    <div class="whats-included-container mt-8">
